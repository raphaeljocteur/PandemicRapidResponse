...
namespace AI
{
    ...
    public static class BT
    {
        ...
        public static RandomSequence RandomSequence(int[] weights = null) { return new AI.RandomSequence(weights); }
    ...
    public abstract class Branch : BTNode
    {
        ...
        public virtual Branch Do(params BTNode[] children)
        {
    ...
    public class RandomSequence : Block
    {
        ...
        public override Branch Do(params BTNode[] children)
        {
